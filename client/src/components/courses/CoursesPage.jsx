    ...
    >
      <div className="container mx-auto px-4">
        ...
        >
          ...
          >
            Browse our extensive collection of high-quality courses designed to
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <Link
                    ...
                    className="block w-full py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-md text-center font-medium hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 transform group-hover:scale-105"
                  >
                    Learn More
                  </Link>
                </div>
