            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              ...
              >
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 text-center">
                  ...
                  <motion.button
                    className="w-full py-3 px-6 bg-white text-blue-600 rounded-md font-bold text-lg mb-3 hover:bg-blue-50 transition-colors flex items-center justify-center"
                  ...
                  {activeTab === "curriculum" && (
                    ...
                    >
                      ...
                      <p className="text-gray-700 mb-6">
                        This course includes {course.curriculum.length} modules
                        with{" "}
                    ...
                    >
                      ...
                      <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                        ...
                        <p className="text-gray-700 mb-4">
                          ...
                          knowledge and practical insights to this course. Their
                          teaching methodology focuses on hands-on learning and
                          practical applications to ensure students gain
                          valuable skills they can apply immediately.
                        </p>
                        <motion.button
                    ...
                    >
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex items-center text-xs text-gray-500 mb-2">
                          ...
                          <span>{relatedCourse.studentsEnrolled} students</span>
                        </div>
                        <Link
          ...
          <div className="lg:w-1/3">
            ...
            >
              ...
              <div className="flex flex-col space-y-3">
                <motion.button
                  className="w-full py-3 px-6 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-md font-bold text-lg hover:from-blue-700 hover:to-indigo-700 transition-colors flex items-center justify-center"
                  whileHover={{ scale: 1.03 }}
                  whileTap={{ scale: 0.98 }}
                  onMouseEnter={() => setCursorVariant("hover")}
                  onMouseLeave={() => setCursorVariant("default")}
